...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while(true)
        {
            ...
            System.out.println("7.Serialize all events to XML file.");
            System.out.println("8.Deserialize all events from XML file.");
            System.out.println("9.Serialise all events to TXT file.");
            System.out.println("10.Deserialize all events to TXT file.");
            ...
            switch(index1) {
                ...
                case 8:
                    try (
                        ...
                        for (int i = 0; i < size; i++) {
                            plan.add((Plan) decoder.readObject());
                        }
                    } catch (Exception e) {
                        System.err.println("Error");
                        break;
                ...
                case 9:
                    FileOutputStream fo;
                    System.out.println("Enter name_file.txt");
                    in.nextLine();
                    ...
                    break;
                case 10:
                    System.out.println("Enter file_name.txt");
                    in.nextLine();
                ...
                case 11:
                    ...
                    for(int i=0;i<plan.size();i++) {
                        System.out.println(i+1+"."+plan.get(i).toString());
                    }
